...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loggedDevices =
        devices.where((d) => deviceIds.contains(d.id)).toList();
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  Row(children: [
                    _SummaryCard(
                        value: '${allLogs.length}', label: 'Total doses'),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            Text(
                                                '${formatLogTime(log.loggedAt)}  ·  ${log.method.name == 'nfc' ? 'NFC' : 'Manual'}',
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    color: context.clrTextSub)),
