    ...
    return Column(
      ...
      children: [
        ...
        Row(children: [
          Expanded(
              child: _TypeCard(
                  label: 'Injectable Pen',
                  tag: 'PEN',
                  tagBg: context.clrPurpleBg,
                  tagFg: AppColors.purpleDark,
          ...
          Expanded(
              child: _TypeCard(
                  label: 'Vial',
                  tag: 'VIAL',
                  tagBg: context.clrTealBg,
                  tagFg: AppColors.tealDark,
        ...
        Text('Tracking Method',
            style: TextStyle(
                ...
                color: context.clrText)),
        const SizedBox(height: 4),
        Text('How will you identify this compound?',
            style: TextStyle(fontSize: 14, color: context.clrTextSub)),
        const SizedBox(height: 16),
                  ...
                  child: Row(children: [
                    Expanded(
                      ...
                      children: [
                        ...
                        Text(
                            '${d.vendor}  ·  ${d.desiredDoseMcg.toStringAsFixed(0)}mcg  ·  ${d.schedule.label}',
                            style: TextStyle(
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          ...
          child:
            ...
            Text(subtitle,
                style: TextStyle(
                    fontSize: 12, color: context.clrTextSub, height: 1.3)),
          ]),
        ),
      );
}
