...
- `minSdk 26` (was originally required by flutter_nfc_kit; we keep it because our `NfcReader.kt` reader-mode flags use API 19+ behaviour and we don't want to think about lower SDK paths)
