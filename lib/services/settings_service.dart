...
class SettingsService {
  ...
  Future<void> setLowInventoryAlerts(bool v) => _prefs.setBool('lowInventoryAlerts', v);
  Future<void> setMissedDoseAlerts(bool v)   => _prefs.setBool('missedDoseAlerts', v);
  ...
  Future<void> setOnboardingComplete() => _prefs.setBool('onboardingComplete', true);
}
